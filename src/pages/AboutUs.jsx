...
const AboutUs = () => {
  return (
    <div class="responsive-container-block bigContainer container">
      <div className="title">
      ...
      <div class="responsive-container-block Container">
        <div class="responsive-container-block textSide">
          ...
          <div className="about-flex grid-2">
            ...
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              ...
              <div class="cardText">
                ...
                <p class="text-blk cardSubHeading">
                  ...
                  expertise in software development, design, and cybersecurity.
                  With a commitment to continuous learning and innovation, we
            ...
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              ...
              <div class="cardText">
                ...
                <p class="text-blk cardSubHeading">
                  Application Development: From desktop to mobile applications,
                  we design and develop custom software that aligns with your
                  ...
                  designed to equip aspiring developers with the skills they
            ...
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              ...
              <div class="cardText">
                ...
                <p class="text-blk cardSubHeading">
                  Expertise: Our experienced team brings a wealth of knowledge
                  and skill to every project. Innovation: We leverage the latest
                  technologies to deliver innovative solutions. Client-Centric:
