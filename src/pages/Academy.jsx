      ...
      <div className="container">
        ...
        <div className="flex">
          <div className="flex-1">
            ...
            <h4>
              ...
              with Blue Elite Tech, we offer a range of courses designed to help
              beginners and recent graduates kick-start their careers in
              technology
            </h4>
          </div>
          <div className="flex-1">
        ...
        <div className="mission">
          ...
          <p>
            ...
            repellendus? Sunt aut distinctio consequuntur cumque at magni quas
            quibusdam? Enim architecto officia dolore corrupti labore vero ipsa
            dicta aut voluptates?
          </p>
          ...
          <p>
            ...
            expertise into the classroom. This ensures that our students receive
          ...
          <p>
            Through our partnership with Blue Elite Tech, we stay connected with
            the latest developments in the tech industry, ensuring that our
            curriculum is always relevant and cutting-edge.
          </p>
        </div>
      </div>
    </main>
